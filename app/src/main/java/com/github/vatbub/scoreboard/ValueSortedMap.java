...
public class ValueSortedMap<K, V> implements Map<K, V> {
     ...
     */
    private Map<K, V> lookupMap = new HashMap<>(3);
     ...
     */
    public ValueSortedMap(boolean invertOrder) {
        map = new TreeMap<>(new KeyByValueComparator(null, invertOrder));
    }
     ...
     */
    public ValueSortedMap(Comparator<? super V> c, boolean invertOrder) {
        map = new TreeMap<>(new KeyByValueComparator(c, invertOrder));
    }
     ...
     */
    public void putAll(@NonNull Map<? extends K, ? extends V> otherMap) {
    ...
    private class KeyByValueComparator implements Comparator<K> {
         ...
         */
        KeyByValueComparator(Comparator<? super V> comparator, boolean invertOrder) {
            if (comparator == null) {
                this.valueComparator = (Comparator<V>) (a, b) -> {
